                ...
                <YStack>
                    <YStack className="">
                        <XStack className="w-full items-center justify-between px-2 mt-2 mb-4">
                            ...
                            <Text className="text-xl font-qsemibold text-green-700">${price}</Text>
                        </XStack>
                        ...
                        <YStack className="items-start">
                            ...
                            <XStack className="w-full items-center justify-between">
                               ...
                               {state && <Image source={icons.alert} className="w-10 h-10 mr-5" tintColor="#ff6633" resizeMode="contain"/> }
                            </XStack>
                        </YStack>
                    </YStack>
                </YStack>

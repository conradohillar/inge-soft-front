...
const AddCarModal = ({ isVisible, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <YStack className="justify-center items-center h-full">
        <YStack className="justify-evenly bg-white rounded-xl h-[90%] w-full py-6">
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <CustomInput
                  ...
                  borderColor={errors.plate ? "border-red-500" : undefined}
                />
              )}
              name="plate"
            />
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <CustomInput
                  ...
                  borderColor={errors.color ? "border-red-500" : undefined}
                />
              )}
              name="color"
            />

...
// import { IDCardManager, ParsedResult, ScannedIDCard } from "./../../services/CameraReader";
...
//   useEffect(() => {
//     (async () => {
//       let success = await initLicense("t0086pwAAAIgVE1xEpCDV9ZP8C3zeY0f4NJQ5QspS66PlsRF6DICRS3idloxz98vS/zKV7Wx8OM7fGAFPEWV2fjMDZ/cu0wWoqHU8Avf58Zca3GjyABR7IgQ=");
//       if (!success) {
